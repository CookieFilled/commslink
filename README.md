<div align="center">
  ...
  [![Security](https://img.shields.io/badge/Security-Unbreakable-success?style=for-the-badge)](#)
</div>
...
<img width="1240" height="579" alt="CommsLink Main Interface" src="https://github.com/user-attachments/assets/e40577c1-cb31-44af-ba9c-b5842b60a158" />

<br>

<img width="223" height="282" alt="Theme Selection" src="https://github.com/user-attachments/assets/6ff48612-fbcd-4511-9df8-c4977127b7c3" />
...
<img width="600" height="287" alt="Absolute Encryption Setup" src="https://github.com/user-attachments/assets/6ff1cecc-9727-4987-a9cb-9fe1f85b400d" />
...
<img width="631" height="486" alt="Encrypted Calling Interface" src="https://github.com/user-attachments/assets/75ed958d-5159-469c-8c3c-317c8d241a43" />
...
* **Security Architecture:** Standard Client-Side Encryption (Zero-knowledge)

---

##  Getting Started

Host your Own on vercel or any other provider
...
```bash
git clone [https://github.com/CookieFilled/commslink.git](https://github.com/CookieFilled/commslink.git)
```
...
Create a `.env` file in the root directory of the project and add your specific configurations. Here is a template to get you started:

```env
# Example .env file
REACT_APP_SIGNALING_SERVER=[https://your-signaling-server.com](https://your-signaling-server.com)
...
```
#Same Variables to be created in vercel or any other provider. 
...
## 🤝 Contributing
Got ideas to make CommsLink even more impenetrable or visually stunning? Pull requests are always welcome. Let's build the future of private communication together!

---

## ⭐️ Support the Project
If you believe that true privacy is a right and you love this project, please **drop a ⭐️ on the repo!** It helps get the word out to other developers.
